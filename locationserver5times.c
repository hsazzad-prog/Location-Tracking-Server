...
float k1=rand()%9, k2=rand()%9, s1=rand()%9, s2=rand()%9, b1=rand()%9, b2=rand()%9;
 	...
 	Distance1=sqrt(((Xmn-k1)*(Xmn-k1))+((Ymn-k2)*(Ymn-k2)));      //mobile with kyle
        ...
        Distance6=sqrt(((s1-2.7)*(s1-2.7))+((s2-0)*(s2-0)));              //sally with mimos2
        Distance7=sqrt(((k1-2.7)*(k1-2.7))+((k2-0)*(k2-0)));              //kyle with mimos2
        Distance8=sqrt(((k1-0)*(k1-0))+((k2-2.53)*(k2-2.53)));              //kyle with mimos1
        Distance9=sqrt(((s1-0)*(s1-0))+((s2-2.53)*(s2-2.53)));              //sally with mimos1
        ...
        Distance14=sqrt(((b1-2.7)*(b1-2.7))+((b2-0)*(b2-0)));              //Bob with mimos2
        Distance15=sqrt(((b1-0)*(b1-0))+((b2-2.53)*(b2-2.53)));              //Bob with mimos1
...
if (Distance1>Distance2 && Distance1>Distance11){
      ...
      //  fprintf (f,"The nearest mobile is Sally with distance %f\n ", Distance2);
        ...
        fprintf(fff,"mimos1  		 	             (2.7,0) \n");
        fprintf(fff,"mimos2  		 	             (0,2.53) \n");        
 	fprintf(fff,"%s 		        (%f,%f) \n",ind.mac,Xmn,Ymn);
