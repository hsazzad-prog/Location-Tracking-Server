...
//add server
			...
			get_in_addr((struct sockaddr_storage *)&their_addr), s, sizeof s);
...
//if ....... = ....{
//if((ff=fopen("/root/mobilenode1.c","r+"))==NULL)
//		{
//		printf("cannot open this file\n");exit(-1);
//		}
//else
...
//         fprintf (ff," Mobile node is Mobile Node 1. The Location is %f, %f \n", X1, Y1);
//}
//}
